            ...
            <div class='bg-white pt-3 col-xl-2 d-none d-md-block col-md-2 col-lg-2 p-0 h-100 sticky-top'>
                ...
                <form method="get" name="menuSide" action="index.php">
                    ...
                    <table class='table table-borderless'>
                        <thead id='landing' onclick="onRouteUser(this.id)" class="pl-4 py-3">
                            <tr>
                                <td class="pl-4 py-4">
                        ...
                        <tbody>
                            ...
                            <tr id='index' onclick="onRouteUser(this.id)">
                                <td class='pl-4 py-3 <?= $class_style[0] ?>'>
                                    <p class='m-0 label-text'>HOME</p>
                                </td>
                            </tr>
                            <tr>
                                <td class='pl-4 py-3 <?= $class_style[1] ?>' id='schedule' onclick="onRouteUser(this.id)">
                                    <p class='m-0 label-text'>SCHEDULE</p>
                                </td>
                            </tr>
                            <tr id='bill' onclick="onRouteUser(this.id)">
